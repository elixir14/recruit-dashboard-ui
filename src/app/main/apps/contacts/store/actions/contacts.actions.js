...
export const GET_TAGS = '[CONTACTS APP] GET TAGS';
export const ADD_TAGS = '[CONTACTS APP] ADD_TAGS';
export const SAVE_CANDIDATE_TAGS = '[CONTACTS APP] SAVE_CANDIDATE_TAGS';
